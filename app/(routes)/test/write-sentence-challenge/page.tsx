      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-4xl">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1 sm:mb-2">
            Write Sentence Challenge
          </h1>
          <p className="text-sm sm:text-base text-gray-600">
            Challenge yourself! Write sentences using German words only - no translations shown. Get AI-powered feedback on your sentences.
          </p>
        </div>
        <WriteSentenceTest showMeaning={false} />
      </div>
    </div>
  );
};

export default WriteSentenceChallenge;
