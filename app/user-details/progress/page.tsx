          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 h-full">
                ...
                <div className="space-y-4">
                  {statsData.map((stat, index) => (
                    <div key={index} className={`border-l-4 ${stat.color} p-4 rounded`}>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <p className="text-sm text-gray-500">Total Words: <span className="font-bold text-gray-700">{WordList.length}</span></p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-6 h-full flex flex-col">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Word Distribution</h2>
                ...
                <div className="space-y-2 max-h-[50vh] overflow-y-auto">
                  {lists[key].length === 0 ? (
                    ...
                    lists[key].map((item: any) => {
                      ...
                      return (
                        <div key={item.id} className="border-b pb-2 mb-2 flex justify-between items-start gap-2">
                          <div className="flex-1">
                            <span className="font-semibold text-indigo-700">#{item.id} {item.word}</span>
